	...
	<?php
        ...
        $outputOptions = array(
            ...
            echo '<tr>';
            echo '<td>';
            echo $this->Form->input('Report.ReportName',array('size'=>'80','maxlength'=>'80','label'=>__d('report_manager','ReportName')));            
            echo '</td>';
            echo '</tr>';
            
            echo '<tr>';
            echo '<td>';
            echo $this->Form->input('Report.Style',array('type'=>'select','options'=>$styleOptions,'label'=>__d('report_manager','Style')));            
            echo '</td>';             
            echo '</tr>';

            echo '<tr>';
            echo '<td>';
            echo $this->Form->input('Report.Output',array('type'=>'select','options'=>$outputOptions,'label'=>__d('report_manager','Output')));            
            echo '</td>';             
            echo '</tr>';
