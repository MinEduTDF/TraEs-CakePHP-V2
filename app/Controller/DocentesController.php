...
class DocentesController extends AppController {
	...
	*/
	...
	function view($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Docente no valido.'));
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->Docente->save($this->data)) {
				$this->Session->setFlash(__('El docente ha sido grabado.'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('El docente no ha sido grabado. Favor, intente nuevamente.'));
			}
		}
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Id no valido para docente.'));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Docente->delete($id)) {
			$this->Session->setFlash(__('Docente borrado.'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Docente no fue borrado.'));
		$this->redirect(array('action' => 'index'));
	}
}
?>