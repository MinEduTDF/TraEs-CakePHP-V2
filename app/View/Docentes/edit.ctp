...
<?php echo $this->Form->create('Docente');?>
	<fieldset>
 		<legend><?php echo __('Editar Docente'); ?></legend>
	         <div id="main">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Borrar'), array('action' => 'delete', $this->Form->value('Docente.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Docente.id'))); ?></li>
