            ...
            <div class="unit">
                ...
                <!--<h3>Datos del Alumno</h3>-->
                     <div class="col-md-4 col-sm-4 col-xs-12">	
                          ...
                          <b>Materia:</b>		
                          <?php echo ($this->Html->link($nota['Materia']['alia'], array('controller' => 'materias', 'action' => 'view', $nota['Materia']['id']))); ?></p>
                           <b>Ciclo:</b>		
                          <?php echo ($this->Html->link($nota['Ciclo']['nombre'], array('controller' => 'ciclos', 'action' => 'view', $nota['Ciclo']['id']))); ?></p>
                     </div>
