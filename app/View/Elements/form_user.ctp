...
<?php
		...
		echo $this->Form->input('password', array('label' => 'Contraseña', 'between' => '<br>', 'class' => 'form-control'));
		echo $this->Form->input('password_confirm', array('label' => 'Confirmar contraseña', 'between' => '<br>', 'class' => 'form-control'));
