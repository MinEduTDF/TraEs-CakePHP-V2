<div class="col-md-6">
	<div class="unit">
       ...
       <div class="text-right">
           ...
           <span class="link"><?php echo $this->Html->link('Borrar', array('controller' => 'mesaexamens', 'action' => 'delete', $mesaexamen['Mesaexamen']['id']), array('confirm' => 'Está seguro de borrar la mesa de exámen nro.'.$mesaexamen['Mesaexamen']['id'], 'class' => 'btn btn-danger')); ?></span> 
       </div>
    </div>
</div>
