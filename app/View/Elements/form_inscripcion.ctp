...
<?php 
        ...
        echo $this->Form->input('fecha_egreso', array('type' => 'text', 'between' => '<br>', 'empty' => '','class' => 'datepicker form-control', 'empty' => ''));
		...
		echo $this->Form->input('fecha_emision_titulo', array('type' => 'text', 'between' => '<br>', 'empty' => '','class' => 'datepicker form-control', 'empty' => ''));
