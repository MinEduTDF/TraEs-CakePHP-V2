<div class="unit">
       ...
       <!--<span class="link"><?php echo $this->Html->link(__('Eliminar'), array('action' => 'delete', $empleado['Empleado']['id']), null, sprintf(__('Esta seguro que desea borrar al empleado %s?'), $empleado['Empleado']['apellido'])); ?></span>-->
