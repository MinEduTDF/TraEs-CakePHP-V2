...
<?php echo $this->Form->create('MesaExamen'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mesa Examen'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MesaExamen.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('MesaExamen.id')))); ?></li>
