<!-- start main -->
 ...
 <!-- end second nav -->
    ...
    <!--<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><strong><?php echo __('Sigla : '); ?></strong></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $centro['Centro']['sigla']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><strong><?php echo __('FechaFundacion: '); ?></strong></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $this->Html->formatTime($centro['Centro']['fechaFundacion']); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><strong><?php echo __('EquipoDirectivo: '); ?></strong></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><strong><?php echo __('Url: '); ?></strong></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	<h3><?php echo __('Orientaciones Relacionadas');?></h3>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('Ver'), array('controller' => 'orientacions', 'action' => 'view', $orientacion['id'])); ?>
				<?php echo $this->Html->link(__('Editar'), array('controller' => 'orientacions', 'action' => 'edit', $orientacion['id'])); ?>
				<!--<?php echo $this->Html->link(__('Borrar'), array('controller' => 'orientacions', 'action' => 'delete', $orientacion['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $orientacion['id'])); ?>-->
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
<?php endif; ?>
	...
	<!--<div class="actions">
		<ul>
			<li><?php echo $this->Html->link(__('Nueva Orientacion'), array('controller' => 'orientacions', 'action' => 'add'));?> </li>
		</ul>
	</div>-->
</div>
<div class="related">
