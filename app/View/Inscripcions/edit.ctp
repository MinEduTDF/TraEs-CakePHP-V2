...
<div class="actions">
	...
	<ul>
		...
		<!--<li><?php echo $this->Html->link(__('Borrar'), array('action' => 'delete', $this->Form->value('Inscripcion.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Inscripcion.id'))); ?></li>-->
