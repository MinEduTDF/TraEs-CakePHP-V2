...
<?php echo $this->Form->create('Materia');?>
	<fieldset>
 		<legend><?php __('Editar Materia'); ?></legend>
	        <div id="main">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Borrar Materia', true), array('action' => 'delete', $this->Form->value('Materia.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Materia.id'))); ?></li>
