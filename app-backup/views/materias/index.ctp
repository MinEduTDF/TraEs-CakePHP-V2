<div class="materias index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $materia['Materia']['id'])); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $materia['Materia']['id'])); ?>
			<!--<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $materia['Materia']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $materia['Materia']['id'])); ?>-->
		</td>
	</tr>
<?php endforeach; ?>
	</table>
