<div class="unit">
	   ...
	   <!--<span class="link"><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $centro['Centro']['id']), null, sprintf(__('Esta seguro que desea eliminar el centro %s?', true), $centro['Centro']['sigla'])); ?></span>-->
