<div class="unit">
       ...
       <!--<span class="link"><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $inventario['Inventario']['id']), null, sprintf(__('Estas seguro que deseas eliminar el Inventario %s?', true), $inventario['Inventario']['nombre'])); ?></span>-->
