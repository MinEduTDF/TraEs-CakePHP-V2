<div class="unit">
       ...
       <!--<span class="link"><?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $docente['Docente']['id']), null, sprintf(__('Esta seguro que desea borrar al docente %s?', true), $docente['Docente']['apellido'])); ?></span>-->
