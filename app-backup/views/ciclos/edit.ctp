...
<?php echo $this->Form->create('Ciclo');?>
	<fieldset>
 		<legend><?php __('Editar Ciclo'); ?></legend>
	        <div id="main">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $this->Form->value('Ciclo.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Ciclo.id'))); ?></li>
