...
<?php echo $this->Form->create('Centro');?>
	<fieldset>
 		<legend><?php __('Editar Centro'); ?></legend>
	         <div id="main">
...
<div class="actions">
	...
	<ul>
		...
		<!--<li><?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $this->Form->value('Centro.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Centro.id'))); ?></li>-->
