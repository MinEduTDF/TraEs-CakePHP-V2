<div class="horarios index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Ver', true), array('action' => 'view', $horario['Horario']['id'])); ?>
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $horario['Horario']['id'])); ?>
			<!--<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $horario['Horario']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $horario['Horario']['id'])); ?>-->
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Nuevo Horario', true), array('action' => 'add')); ?></li>
