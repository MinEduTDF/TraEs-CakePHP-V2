...
class CargosController extends AppController {
	...
	function view($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Cargo no valido', true));
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->Cargo->save($this->data)) {
				$this->Session->setFlash(__('El cargo ha sido grabado', true));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('El cargo no ha sido grabado. Favor, intente nuevamente.', true));
			}
		}
		$centros = $this->Cargo->Centro->find('list');
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Id no valido para cargo', true));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Cargo->delete($id)) {
			$this->Session->setFlash(__('Cargo borrado', true));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Cargo no borrado', true));
		$this->redirect(array('action' => 'index'));
	}
