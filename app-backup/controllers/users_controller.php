...
class UsersController extends AppController {
	...
	*/
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->User->save($this->data)) {
				$this->Session->setFlash(__('El usuario ha sido grabado.', true));
				$this->redirect(array('action' => 'index'));
			} else {
	...
	function edit($id = null) {
		...
		if (!empty($this->data)) {
			if ($this->User->save($this->data)) {
				...
				$this->Session->setFlash(__('El usuario no ha sido grabado. Favor, intente nuevamente.', true));
			}
		}
		if (empty($this->data)) {
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Id no valida para usuario.', true));
			$this->redirect(array('action'=>'index'));
		}
		...
		$this->Session->setFlash(__('Usuario no fue borrado.', true));
		$this->redirect(array('action' => 'index'));
	}
