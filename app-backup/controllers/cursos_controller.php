...
class CursosController extends AppController {
	...
	function view($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Curso no valido.', true));
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->Curso->save($this->data)) {
				$this->Session->setFlash(__('El curso ha sido grabado.', true));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('El curso no ha sido grabado. Favor, intente nuevamente.', true));
			}
		}
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Id no valido para curso', true));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Curso->delete($id)) {
			$this->Session->setFlash(__('Curso borrado', true));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Curso no fue borrado', true));
		$this->redirect(array('action' => 'index'));
	}
}
?>