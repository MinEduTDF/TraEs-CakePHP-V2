...
class EmpleadosController extends AppController {
    ...
    function view($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Empleado no valido.', true));
	...
	function add() {
		if (!empty($this->data)) {
			...
			if ($this->Empleado->save($this->data)) {
				$this->Session->setFlash(__('El empleado ha sido grabado.', true));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('El empleado no ha sido grabado. Favor, intente nuevamente.', true));
			}
		}
	...
	function delete($id = null) {
		if (!$id) {
			$this->Session->setFlash(__('Id no valida para empleado.', true));
			$this->redirect(array('action'=>'index'));
		}
		if ($this->Empleado->delete($id)) {
			$this->Session->setFlash(__('Empleado borrado.', true));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Empleado no fue borrado.', true));
		$this->redirect(array('action' => 'index'));
	}
}
?>